...
1. When Base64 mode is disabled for the completions API, Base64-encoded images in requests are converted to image URLs, reducing memory usage during workflow execution.
